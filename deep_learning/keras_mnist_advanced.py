...
try:
    result_dir = os.environ['UYUNI_OUTPUT_DIR']
        
except Exception as e:
    result_dir = '/horovod_examples/result'
...
if hvd.rank() == 0:
    callbacks.append(keras.callbacks.ModelCheckpoint(os.path.join(result_dir, 'checkpoint-{epoch}.h5')))
